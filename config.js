System.config({
  ...
  "bundles": {
    "dist/app-bundle": [
      "npm:core-js@0.9.7/modules/$.fw",
      "npm:core-js@0.9.7/modules/$.dom-create",
      "npm:core-js@0.9.7/modules/$.uid",
      "npm:core-js@0.9.7/modules/$.def",
      "npm:core-js@0.9.7/modules/$.invoke",
      "npm:core-js@0.9.7/modules/$.assert",
      "npm:core-js@0.9.7/modules/$.array-includes",
      "npm:core-js@0.9.7/modules/$.replacer",
      "npm:core-js@0.9.7/modules/$.throws",
      "npm:core-js@0.9.7/modules/$.keyof",
      "npm:core-js@0.9.7/modules/$.enum-keys",
      "npm:core-js@0.9.7/modules/$.assign",
      "npm:core-js@0.9.7/modules/es6.object.is",
      "npm:core-js@0.9.7/modules/$.set-proto",
      "npm:core-js@0.9.7/modules/es6.object.to-string",
      "npm:core-js@0.9.7/modules/es6.object.statics-accept-primitives",
      "npm:core-js@0.9.7/modules/es6.function.name",
      "npm:core-js@0.9.7/modules/es6.function.has-instance",
      "npm:core-js@0.9.7/modules/es6.number.constructor",
      "npm:core-js@0.9.7/modules/es6.number.statics",
      "npm:core-js@0.9.7/modules/es6.math",
      "npm:core-js@0.9.7/modules/es6.string.from-code-point",
      "npm:core-js@0.9.7/modules/es6.string.raw",
      "npm:core-js@0.9.7/modules/$.string-at",
      "npm:core-js@0.9.7/modules/$.iter",
      "npm:core-js@0.9.7/modules/$.iter-define",
      "npm:core-js@0.9.7/modules/es6.string.code-point-at",
      "npm:core-js@0.9.7/modules/es6.string.ends-with",
      "npm:core-js@0.9.7/modules/es6.string.includes",
      "npm:core-js@0.9.7/modules/$.string-repeat",
      "npm:core-js@0.9.7/modules/es6.string.starts-with",
      "npm:core-js@0.9.7/modules/$.iter-call",
      "npm:core-js@0.9.7/modules/$.iter-detect",
      "npm:core-js@0.9.7/modules/es6.array.of",
      "npm:core-js@0.9.7/modules/$.unscope",
      "npm:core-js@0.9.7/modules/$.species",
      "npm:core-js@0.9.7/modules/es6.array.copy-within",
      "npm:core-js@0.9.7/modules/es6.array.fill",
      "npm:core-js@0.9.7/modules/es6.array.find",
      "npm:core-js@0.9.7/modules/es6.array.find-index",
      "npm:core-js@0.9.7/modules/es6.regexp",
      "npm:core-js@0.9.7/modules/$.for-of",
      "npm:process@0.10.1/browser",
      "npm:core-js@0.9.7/modules/$.collection-strong",
      "npm:core-js@0.9.7/modules/$.collection",
      "npm:core-js@0.9.7/modules/es6.set",
      "npm:core-js@0.9.7/modules/$.collection-weak",
      "npm:core-js@0.9.7/modules/es6.weak-set",
      "npm:core-js@0.9.7/modules/$.own-keys",
      "npm:core-js@0.9.7/modules/es7.array.includes",
      "npm:core-js@0.9.7/modules/es7.string.at",
      "npm:core-js@0.9.7/modules/$.string-pad",
      "npm:core-js@0.9.7/modules/es7.string.rpad",
      "npm:core-js@0.9.7/modules/es7.regexp.escape",
      "npm:core-js@0.9.7/modules/es7.object.get-own-property-descriptors",
      "npm:core-js@0.9.7/modules/es7.object.to-array",
      "npm:core-js@0.9.7/modules/$.collection-to-json",
      "npm:core-js@0.9.7/modules/es7.set.to-json",
      "npm:core-js@0.9.7/modules/js.array.statics",
      "npm:core-js@0.9.7/modules/$.partial",
      "npm:core-js@0.9.7/modules/web.immediate",
      "npm:core-js@0.9.7/modules/web.dom.iterable",
      "npm:core-js@0.9.7/modules/core.dict",
      "npm:core-js@0.9.7/modules/core.iter-helpers",
      "npm:core-js@0.9.7/modules/core.$for",
      "npm:core-js@0.9.7/modules/core.delay",
      "npm:core-js@0.9.7/modules/core.function.part",
      "npm:core-js@0.9.7/modules/core.object",
      "npm:core-js@0.9.7/modules/core.array.turn",
      "npm:core-js@0.9.7/modules/core.number.iterator",
      "npm:core-js@0.9.7/modules/core.number.math",
      "npm:core-js@0.9.7/modules/core.string.escape-html",
      "npm:core-js@0.9.7/modules/core.date",
      "npm:core-js@0.9.7/modules/core.global",
      "npm:core-js@0.9.7/modules/core.log",
      ...
      "npm:core-js@0.9.7/modules/$",
      "npm:core-js@0.9.7/modules/$.wks",
      "npm:core-js@0.9.7/modules/$.ctx",
      "npm:core-js@0.9.7/modules/es6.symbol",
      "npm:core-js@0.9.7/modules/es6.object.assign",
      "npm:core-js@0.9.7/modules/es6.object.set-prototype-of",
      "npm:core-js@0.9.7/modules/es6.string.iterator",
      "npm:core-js@0.9.7/modules/es6.string.repeat",
      "npm:core-js@0.9.7/modules/es6.array.from",
      "npm:core-js@0.9.7/modules/es6.array.iterator",
      "npm:core-js@0.9.7/modules/es6.array.species",
      "npm:process@0.10.1",
      "npm:core-js@0.9.7/modules/es6.map",
      "npm:core-js@0.9.7/modules/es6.weak-map",
      "npm:core-js@0.9.7/modules/es6.reflect",
      "npm:core-js@0.9.7/modules/es7.string.lpad",
      "npm:core-js@0.9.7/modules/es7.map.to-json",
      "npm:core-js@0.9.7/modules/web.timers",
      ...
      "npm:core-js@0.9.7/modules/$.cof",
      "npm:core-js@0.9.7/modules/$.array-methods",
      ...
      "aurelia-skeleton-navigation/flickr",
      "aurelia-skeleton-navigation/child-router",
